...
steamGame.Boot.prototype = {
    preload: function() {
        ...
        //preload the loading screen stuff dfor the actual preload state later
        this.load.image('logo', '/sprites/load/logo.png');
        this.load.image('preloadbar', '/sprites/load/preloadbar.png');
    },
    create: function() {
